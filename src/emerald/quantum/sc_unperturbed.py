...
from ..potentials.sc_potential import sC_potential_vec
from tqdm import tqdm


def sC_hamiltonian(alpha, position_grid):
    # Grid setup
    ...
    V = np.diag(sC_potential_vec(alpha, r_grid))  # Diagonal potential
    H = T + V

    return H, position_grid


def sC_eigstates(H, position_grid, base_size):
