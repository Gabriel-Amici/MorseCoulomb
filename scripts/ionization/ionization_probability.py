...
Program to calculate the probability of ionization of an atom modeled by the MsC potential subject to periodic perturbation. 
Input parameters:
...
def ionization_probability(
    ...
    data["Simulation Results"]["ionization_probability"] = ionized
